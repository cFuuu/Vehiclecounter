...
def vehicle_count(video_path):
    # 直接在這裡定義偵測區間
    detection_zone = [200, 600, 1280, 610]  # [x1, y1, x2, y2]
    
    cap = cv2.VideoCapture("D:/Harry/ITS/Vehiclecounter/Video/test_2.mp4")
    ...
    while True:
        ...
        for contour in contours:
            if cv2.contourArea(contour) > 3000:  # 調整此閾值以適應您的場景
