...
def vehicle_count(video_path):
    ...
    detection_zones = [
        {"coords": [250, 580, 530, 590], "color": (255, 0, 0), "count": 0},   # 藍色區間
        {"coords": [525, 550, 800, 590], "color": (0, 255, 102), "count": 0},  # 綠色區間
        {"coords": [800, 525, 1050, 560], "color": (0, 255, 255), "count": 0},  # 黃色區間
        {"coords": [1000, 450, 1250, 480], "color": (0, 165, 255), "count": 0},  # 橙色區間
        # 可以繼續添加更多區間
    ]
